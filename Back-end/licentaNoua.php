        ...
        <li id="cid_34" class="form-input-wide" data-type="control_head">
          <div>
            <div class="form-header-group col-md-7" >
                      ...
                      <div class="col-md-4">
                          <img src="https://www.odoo.com/apps/icon_image?module_id=18835" style="width:250px; height:250px; margin-top:50px; margin-left:20px"
                            alt="Relevant textual alternative to the image" />
                      </div>
          </div>
            ...
            <div  class="form-input jf-required cid_1">
              <div class="general_name" data-wrapper-react="true">
                <span id="num" class="form-sub-label-container" style="vertical-align:top;">
                  <input type="text"  name="Licenta_Numele_De_Familie" class="form-textbox first_1" size="10" value="" data-component="first" />
                ...
                <span id="initiala" class="form-sub-label-container" style="vertical-align:top;">
                  <input type="text" name="Licenta_Initiala_Tata" class="form-textbox middle_1" size="10" value="" data-component="middle" />
				  <span style="color:red">
				  <?php
					  if(isset($_POST['Submit'])) {
                ...
                <span id="prenum" class="form-sub-label-container" style="vertical-align:top;">
                  <input type="text" name="Licenta_Prenumele" class="form-textbox last_1" size="15" value="" data-component="last" />
				  <span style="color:red">
				  <?php
					  if(isset($_POST['Submit'])) {
            ...
            <div  class="form-input jf-required cid_1">
              <div class="general_name" data-wrapper-react="true">
                <span  class="form-sub-label-container" style="vertical-align:top; width:25%;padding:0;margin:0;">
                  <input type="text"  name="Licenta_Prenume_Mama" class="form-textbox first_1" size="10" value="" data-component="first" />
				  <span style="color:red">
				  <?php
					  if(isset($_POST['Submit'])) {
                ...
                <span  class="form-sub-label-container" style="vertical-align:top; width:24%;padding:0;margin:0;">
                  <input type="text" name="Licenta_Prenume_Tata" class="form-textbox middle_1" size="10" value="" data-component="middle" />
				  <span style="color:red">
				  <?php
					  if(isset($_POST['Submit'])) {
            ...
            <div  class="form-input jf-required cid_1">
              <div data-wrapper-react="true">
                <span id="CNP" class="form-sub-label-container" style="vertical-align:top; padding:0; margin:0">
                  <input type="text"  name="Licenta_CNP" class="form-textbox first_1" size="20" value="" data-component="first" />
				  <span style="color:red">
				  <?php
					  if(isset($_POST['Submit'])) {
                ...
                <span  class="form-sub-label-container" style="vertical-align:top; width:6%;padding:0;margin:0;">
                  <input type="text"  name="Licenta_Tip_Buletin" class="form-textbox first_1" size="20"  data-component="first" />
				  <span style="color:red">
				  <?php
					  if(isset($_POST['Submit'])) {
					    $v_Licenta_Tip_Buletin = $_POST["Licenta_Tip_Buletin"];  // V
	                    $vLicenta_Tip_Buletin = validNume($v_Licenta_Tip_Buletin);
                ...
                <span  class="form-sub-label-container" style="vertical-align:top; width:10%;padding:0;margin:0;">
                  <input type="text"  name="Licenta_Serie_Buletin" class="form-textbox first_1" size="20"  data-component="first" />
				  <span style="color:red">
				  <?php
					  if(isset($_POST['Submit'])) {
                ...
                <span  class="form-sub-label-container" style="vertical-align:top; width:10%;padding:0;margin:0;">
                  <input type="text"  name="Licenta_Numar_Buletin" class="form-textbox first_1" size="20"  data-component="first" />
				  <span style="color:red">
				  <?php
					  if(isset($_POST['Submit'])) {
					    $v_Licenta_Serie_Buletin = $_POST["Licenta_Numar_Buletin"];  // V
						if($v_Licenta_Serie_Buletin>0 && strlen($v_Licenta_Serie_Buletin)!=6)
						  echo "Ai completat gresit!";
					  }
				  ?>
				  </span>
                ...
                <span  class="form-sub-label-container" style="vertical-align:top; width:10%;padding:0;margin:0;">
                  <input type="text"  name="Licenta_Buletin_Eliberat_De" class="form-textbox first_1" size="20"  data-component="first" />
				  <span style="color:red">
				  <?php
					  if(isset($_POST['Submit'])) {
					    $v_Licenta_Buletin_Eliberat_De = $_POST["Licenta_Buletin_Eliberat_De"];  // V
	                    $vLicenta_Buletin_Eliberat_De = validNume($v_Licenta_Buletin_Eliberat_De);
            ...
            <div class="form-input jf-required cid_1">
                  ...
                  <tbody>
                      ...
                      <tr> 
                         <td >
                            ...
                            <span class="form-sub-label-container" style="vertical-align:top; width:44%">
                              <input type="text"  name="Licenta_Strada" class="form-textbox first_1" size="15" value="" data-component="first" />
                            ...
                            <span class="form-sub-label-container" style="vertical-align:top; width:10%">
                              <input type="text" name="Licenta_Numar" class="form-textbox middle_1" size="15"  data-component="middle" />
                              <label class="form-sub-label"   style="min-height:13px;"> Num&#259;rul</label>
                            </span>
                            <span class="form-sub-label-container" style="vertical-align:top; width:10%">
                              <input type="text"  name="Licenta_Bloc" class="form-textbox last_1" size="15" data-component="last" />
                              <label class="form-sub-label"  style="min-height:13px;"> Bloc </label>
                            </span>
                            <span class="form-sub-label-container" style="vertical-align:top; width:10%">
                              <input type="text"  name="Licenta_Scara" class="form-textbox last_1" size="15" data-component="last" />
                              <label class="form-sub-label last_1"  style="min-height:13px;"> Scara </label>
                            </span>
                            <span class="form-sub-label-container" style="vertical-align:top; width:10% ">
                              <input type="text"  name="Licenta_Etaj" class="form-textbox last_1" size="15"  data-component="last" />
                            ...
                            <span class="form-sub-label-container" style="vertical-align:top; width:11%; margin:0px; padding:0px">
                              <input type="text"  name="Licenta_Apartament" class="form-textbox last_1" size="15" data-component="last" style="margin:0px; padding:0px" />
                      ...
                      <tr>
                        ...
                        <span class="form-sub-label-container" style="vertical-align:top; width:24%" >
                            <input type="text"  name="Licenta_Localitate" class="form-textbox form-address-city first_1" size="21"  data-component="city" />
                        ...
                        <span class="form-sub-label-container" style="vertical-align:top; width:24%">
                          <input type="text" name="Licenta_Cod_Postal" class="gen" size="16" value="" data-component="zip" />
				...
				<?php
					if(isset($_POST['Submit'])) {
						...
						if($vTest_Locuinta != 1)
							echo "Ai completat gresit minim un camp din adresa";
					}
				?>
				</span>
            </div>
          ...
          <li class="form-line form-line-column form-col-1" data-type="control_phone" id="id_6" style="width:50%">
                ...
                <div id="cid_6" class="form-input jf-required" style="width:100%">
                  <div data-wrapper-react="true" style="width:100%">
                    <span class="form-sub-label-container" style="vertical-align:top; width:100%" >
                      <input type="tel" id="input_6_phone" name="Licenta_Telefon" class="form-textbox" size="20" value="" data-component="phone" style="width:100%; height:40px"/>
					  <br>
					  <span style="color:red">
					  <?php
						if(isset($_POST['Submit'])) {
...
<?php
  ...
  if(isset($_POST['Submit'])){
    ...
    if(!$connection)
      ...
      if($vLicenta_CNP !=0 && $vNumele_De_Familie !=0 
         && $vLicenta_Prenumele !=0 && $vLicenta_Initiala_Tata !=0
         && $vLicenta_PrenumeMama !=0 && $vLicenta_PrenumeTata !=0 
         && $vLicenta_Telefon !=0 && $vLicenta_Email !=0
         && $vLicenta_Nationalitate !=0 && $vLicenta_Etnie !=0
         && $vLicenta_Limba_Materna != 0 && $vLicenta_Tip_Buletin !=0
         && $vLicenta_Serie_Buletin !=0 && $vLicenta_Buletin_Eliberat_De != 0 && $vLicenta_Medie_BAC != 0 && $vLicenta_Nota_MI != 0){
