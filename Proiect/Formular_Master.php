                            ...
                            <div class="form-input jf-required cid_1">
                                ...
                                <div class="general_name" data-wrapper-react="true">
                                    ...
                                    <span  class="form-sub-label-container" style="vertical-align:top; width:24%;padding:0;margin:0;">
                                        ...
                                        <input type="text" name="Master_Prenume_Tata" class="form-textbox middle_1" size="10" placeholder="ex: Cristian / Cristi Ionu&#355; / Cristi-Ionu&#355;" data-component="middle" value="
                                        <?php 
                                    ...
                                    <span  class="form-sub-label-container" style="vertical-align:top; width:25%;padding:0;margin:0;">
                                        ...
                                        <select class="form-dropdown form-address-country" style="width:100%; height:40px" name="Master_Sex" >
                                            ...
                                            <option name="sexFeminin" value="">Feminin</option>

                                            <option name="sexMasculin" value="">Masculin</option>
...
<<<<<<< Updated upstream:Front-end/master-form.html
                                      <input type="text" name="nationalitate" class="form-textbox first_1" size="20" value="" data-component="first" />
...
>>>>>>> Stashed changes:Back-end/Formular_Master.php
...
<<<<<<< Updated upstream:Front-end/master-form.html
                                      <input type="text" name="etnie" class="form-textbox first_1" size="20"  data-component="first" />
=======
...
<<<<<<< Updated upstream:Front-end/master-form.html
                                      <input type="text"  name="limbaMaterna" class="form-textbox first_1" size="20"  data-component="first" />
=======
...
>>>>>>> Stashed changes:Back-end/Formular_Master.php
                            ...
                            <div>
                                ...
                                <span class="form-sub-label-container liceu" style="vertical-align:top; width:100%;">
                                    ...
                                    <select  class="form-dropdown form-address-country liceu" name="Master_Liceu">
                            ...
                            <div>
                                ...
                                <span class="form-sub-label-container liceu" style="vertical-align:top; width:100%;">
                                    ...
                                    <select  class="form-dropdown form-address-country liceu" name="Master_Universitate">
...
=======
                                    <div class="col-md-12" style="margin-top:10px">
                                        <input style="width: 40px; height:30px;" type="number" name="Master_Ing_Soft_Taxa" value=""/>
														<span style="color:red">
															<?php 
																if(isset($_POST['Submit'])) {
																	$v_Master_preferinta = $_POST["Master_Ing_Soft_Taxa"];  // V
																	$v_Master_preferinta = validPreferinta($v_Master_preferinta);
																	if($v_Master_preferinta==0)
																		echo "C&#226;mp invalid!";
																}
															?>
														</span>
                                    ...
                                    <div class="col-md-12" style="margin-top:10px"> 
                                        <input style="width: 40px; height:30px;" type="number" name="Master_Sist_Distr_Taxa" value="" />
														<span style="color:red">
															<?php 
																if(isset($_POST['Submit'])) {
																	$v_Master_preferinta = $_POST["Master_Sist_Distr_Taxa"];  // V
																	$v_Master_preferinta = validPreferinta($v_Master_preferinta);
																	if($v_Master_preferinta==0)
																		echo "C&#226;mp invalid!";
																}
                                    ...
                                    <div class="col-md-12" style="margin-top:10px">
                                        <input style="width: 40px; height:30px;" type="number" name="Master_Sec_Info_Taxa"value="" />
														<span style="color:red">
															<?php 
																if(isset($_POST['Submit'])) {
																	$v_Master_preferinta = $_POST["Master_Sec_Info_Taxa"];  // V
																	$v_Master_preferinta = validPreferinta($v_Master_preferinta);
																	if($v_Master_preferinta==0)
																		echo "C&#226;mp invalid!";
																}
                                    ...
                                    <div class="col-md-12" style="margin-top:10px">
                                        <input style="width: 40px; height:30px;" type="number" name="Master_Opt_Comp_Taxa" value="" />
														<span style="color:red">
															<?php 
																if(isset($_POST['Submit'])) {
																	$v_Master_preferinta = $_POST["Master_Opt_Comp_Taxa"];  // V
																	$v_Master_preferinta = validPreferinta($v_Master_preferinta);
																	if($v_Master_preferinta==0)
																		echo "C&#226;mp invalid!";
																}
...
=======
                                    <div class="col-md-12" style="margin-top:10px">
                                        <input style="width: 40px; height:30px;" type="number" name="Master_Lin_Comp_Taxa" value="" />
														<span style="color:red">
															<?php 
																if(isset($_POST['Submit'])) {
																	$v_Master_preferinta = $_POST["Master_Lin_Comp_Taxa"];  // V
																	$v_Master_preferinta = validPreferinta($v_Master_preferinta);
																	if($v_Master_preferinta==0)
																		echo "C&#226;mp invalid!";
																}
                                    ...
                                    <div class="col-md-12" style="margin-top:10px">
                                        <input style="width: 40px; height:30px;" type="number" name="Master_Stud_Avan_Taxa" value="" />
														<span style="color:red">
															<?php 
																if(isset($_POST['Submit'])) {
																	$v_Master_preferinta = $_POST["Master_Stud_Avan_Taxa"];  // V
																	$v_Master_preferinta = validPreferinta($v_Master_preferinta);
																	if($v_Master_preferinta==0)
																		echo "C&#226;mp invalid!";
																}
                                    ...
                                    <div class="col-md-12" style="margin-top:10px">
                                        <input style="width: 40px; height:30px;" type="number" name="Master_Ing_Soft_Buget" value="" />
														<span style="color:red">
															<?php 
																if(isset($_POST['Submit'])) {
																	$v_Master_preferinta = $_POST["Master_Ing_Soft_Buget"];  // V
																	$v_Master_preferinta = validPreferinta($v_Master_preferinta);
																	if($v_Master_preferinta==0)
																		echo "C&#226;mp invalid!";
																}
                                    ...
                                    <div class="col-md-12" style="margin-top:10px">
                                        <input style="width: 40px; height:30px;" type="number" name="Master_Sist_Distr_Buget" value="" />
														<span style="color:red">
															<?php 
																if(isset($_POST['Submit'])) {
																	$v_Master_preferinta = $_POST["Master_Sist_Distr_Buget"];  // V
																	$v_Master_preferinta = validPreferinta($v_Master_preferinta);
																	if($v_Master_preferinta==0)
																		echo "C&#226;mp invalid!";
																}
...
=======
                                    <div class="col-md-12" style="margin-top:10px">
                                        <input style="width: 40px; height:30px;" type="number" value="Master_Sec_Info_Buget" value="" />
														<span style="color:red">
															<?php 
																if(isset($_POST['Submit'])) {
																	$v_Master_preferinta = $_POST["Master_Sec_Info_Buget"];  // V
																	$v_Master_preferinta = validPreferinta($v_Master_preferinta);
																	if($v_Master_preferinta==0)
																		echo "C&#226;mp invalid!";
																}
                                    ...
                                    <div class="col-md-12" style="margin-top:10px">
                                        <input style="width: 40px; height:30px;" type="number" value="Master_Opt_Comp_Buget" value="" />
														<span style="color:red">
															<?php 
																if(isset($_POST['Submit'])) {
																	$v_Master_preferinta = $_POST["Master_Opt_Comp_Buget"];  // V
																	$v_Master_preferinta = validPreferinta($v_Master_preferinta);
																	if($v_Master_preferinta==0)
																		echo "C&#226;mp invalid!";
																}
                                    ...
                                    <div class="col-md-12" style="margin-top:10px">
                                        <input style="width: 40px; height:30px;" type="number" value="Master_Lin_Comp_Buget" value="" />
														<span style="color:red">
															<?php 
																if(isset($_POST['Submit'])) {
																	$v_Master_preferinta = $_POST["Master_Lin_Comp_Buget"];  // V
																	$v_Master_preferinta = validPreferinta($v_Master_preferinta);
																	if($v_Master_preferinta==0)
																		echo "C&#226;mp invalid!";
																}
